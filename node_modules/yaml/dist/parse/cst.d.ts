export { createScalarToken, resolveAsScalar, setScalarValue } from 'yaml/dist/parse/cst-scalar';
export { stringify } from 'yaml/dist/parse/cst-stringify';
export { visit, Visitor, VisitPath } from 'yaml/dist/parse/cst-visit';
