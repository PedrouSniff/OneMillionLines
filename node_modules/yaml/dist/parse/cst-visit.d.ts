import type { CollectionItem, Document } from 'yaml/dist/parse/cst';
...
export declare namespace visit {
    ...
    var parentCollection: (cst: Document | CollectionItem, path: VisitPath) => import("yaml/dist/parse/cst").BlockMap | import("yaml/dist/parse/cst").BlockSequence | import("yaml/dist/parse/cst").FlowCollection;
}
